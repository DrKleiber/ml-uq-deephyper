...
if __name__ == '__main__':
    ...
    dense_test = DenseNet(in_channels=5, out_channels=1, blocks=(3, 6, 3), growth_rate=16,      # in this version, only 7 input features are considered (P,T,Vx,Vy,Vz,Wall distance)
                      init_features=32, drop_rate=0, bn_size=4,      # the only output is turbulent viscosity
                      bottleneck=True, out_activation='ReLU')
    print(dense_test)
    x = torch.Tensor(8, 5, 32,128)
